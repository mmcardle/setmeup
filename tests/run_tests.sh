...
FAST_BATS_FILES='$HOME/tests/backup.bats $HOME/tests/claude_code.bats $HOME/tests/dotfiles.bats $HOME/tests/idempotency.bats $HOME/tests/update_script.bats'
...
fast_image_hash() {
    local files=(
        ...
        "$REPO_ROOT/tests/idempotency.bats"
